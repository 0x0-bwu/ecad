...
int main(int argc, char * argv[])
{
    ...
    std::string filename = generic::fs::DirName(__FILE__).string() + ECAD_SEPS + "data" + ECAD_SEPS + "design" + ECAD_SEPS + "CAS300M12BM2_Hierarchy.ecad";
    layout->GetDatabase()->Save(filename, EArchiveFormat::BIN); 
    auto test = eDataMgr.LoadDatabase(filename);   
    ...
    filename = generic::fs::DirName(__FILE__).string() + ECAD_SEPS + "data" + ECAD_SEPS + "design" + ECAD_SEPS + "CAS300M12BM2.ecad";
    layout->GetDatabase()->Save(filename, EArchiveFormat::BIN);
