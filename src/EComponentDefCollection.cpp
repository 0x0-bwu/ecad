...
ECAD_INLINE void EComponentDefCollection::save(Archive & ar, const unsigned int version) const
{
    ECAD_UNUSED(version)
...
template <typename Archive>
ECAD_INLINE void EComponentDefCollection::load(Archive & ar, const unsigned int version)
{
    ECAD_UNUSED(version)
    boost::serialization::void_cast_register<EComponentDefCollection, IComponentDefCollection>();
    boost::serialization::void_cast_register<EComponentDefCollection, IDefinitionCollection>();
