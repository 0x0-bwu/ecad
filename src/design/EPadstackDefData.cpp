...
void EVia::serialize(Archive & ar, const unsigned int version)
{
    ECAD_UNUSED(version)
...
template <typename Archive>
void EPad::serialize(Archive & ar, const unsigned int version)
{
    ECAD_UNUSED(version)
...
template <typename Archive>
void EBump::serialize(Archive & ar, const unsigned int version)
{
    ECAD_UNUSED(version)
...
template <typename Archive>
void EPadstackDefData::serialize(Archive & ar, const unsigned int version)
{
    ECAD_UNUSED(version)
...
EVia::EVia(const EVia & other)
{
    *this = other;
}

EVia & EVia::operator= (const EVia & other)
{
...
EBump::EBump(const EBump & other)
{
    *this = other;
}

EBump & EBump::operator= (const EBump & other)
{
...
std::string EPadstackDefData::GetMaterial() const
{
    return m_material;
}
void EPadstackDefData::SetMaterial(const std::string & material)
{
    m_material = material;
}

void EPadstackDefData::SetLayers(const std::vector<std::string> & layers)
{
...
bool EPadstackDefData::SetPadParameters(ELayerId layerId, UPtr<EShape> shape, const EPoint2D & offset, EFloat rotation)
{
...
bool EPadstackDefData::GetPadParameters(ELayerId layerId, CPtr<EShape> & shape, EPoint2D & offset, EFloat & rotation) const
{
    if(layerId == noLayer) return false;
    int size = static_cast<int>(m_pads.size());
    if(layerId >= size) return false;
...
bool EPadstackDefData::SetPadParameters(const std::string & layer, UPtr<EShape> shape, const EPoint2D & offset, EFloat rotation)
{
    return SetPadParameters(GetPadLayerId(layer), std::move(shape), offset, rotation);
}

bool EPadstackDefData::GetPadParameters(const std::string & layer, CPtr<EShape> & shape, EPoint2D & offset, EFloat & rotation) const
{
    return GetPadParameters(GetPadLayerId(layer), shape, offset, rotation);
}

void EPadstackDefData::SetViaParameters(UPtr<EShape> shape, const EPoint2D & offset, EFloat rotation)
{
...
void EPadstackDefData::GetViaParameters(CPtr<EShape> & shape, EPoint2D & offset, EFloat & rotation) const
{
...
void EPadstackDefData::SetTopSolderBumpParameters(UPtr<EShape> shape, EFloat thickness)
{
...
bool EPadstackDefData::GetTopSolderBumpParameters(CPtr<EShape> & shape, EFloat & thickness) const
{
...
void EPadstackDefData::SetBotSolderBallParameters(UPtr<EShape> shape, EFloat thickness)
{
...
bool EPadstackDefData::GetBotSolderBallParameters(CPtr<EShape> & shape, EFloat & thickness) const
{
...
void EPadstackDefData::SetTopSolderBumpMaterial(const std::string & material)
{
    m_solderBumpBall.first.material = material;
}

const std::string & EPadstackDefData::GetTopSolderBumpMaterial() const
{
    return m_solderBumpBall.first.material;
}

void EPadstackDefData::SetBotSolderBallMaterial(const std::string & material)
{
    m_solderBumpBall.second.material = material;
}

const std::string & EPadstackDefData::GetBotSolderBallMaterial() const
{
    return m_solderBumpBall.second.material;
}

bool EPadstackDefData::hasTopSolderBump() const
{
    const auto & topBump = m_solderBumpBall.first;
...
bool EPadstackDefData::hasBotSolderBall() const
{
    const auto & botBall = m_solderBumpBall.second;
...
ELayerId EPadstackDefData::GetPadLayerId(const std::string & layer) const
{
